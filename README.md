...
# API шлюз
Сервис 1 - http://localhost:5028/swagger/index.html
...
```bash
dotnet run --project src/Services/Service1/Api/Service1.Api.csproj

dotnet run --project src/Services/Service2/Api/Service2.Api.csproj
```
